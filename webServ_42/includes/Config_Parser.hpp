...
/*   Updated: 2025/10/21 10:31:26 by gcosta-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
class Config_Parser
{
  private:
	...
	int set_server_value(Server *server, const std::string &key,
		const std::string &value);
	int set_location_value(Location *location, const std::string &key,
		const std::string &value);
